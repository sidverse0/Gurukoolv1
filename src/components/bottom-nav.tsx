...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-4 inset-x-0 z-40 h-16 mx-4 rounded-t-3xl border-border/50 bg-background/90 backdrop-blur-lg md:hidden shadow-[0_-4px_16px_rgba(0,0,0,0.05)]">
